...
contract Stake {
    BlockTunixCoin private tokenAddress;
    ...
    constructor(address token_Address) {
        require(token_Address != address(0), "TokenAddress != 0");
        tokenAddress = BlockTunixCoin(token_Address);
    ...
    function Unstake() external {
        ...
        tokenAddress.transfer(
            stakeEthers.userAddress,
            stakeEthers.claimedReward
        );
        payable(msg.sender).transfer(stakeEthers.stakeAmount);
    ...
    function widthdrawReward(uint256 reward) external {
        ...
        tokenAddress.transfer(stakeEthers.userAddress, reward);
        stakeDetails[msg.sender] = stakeEthers;
    }
